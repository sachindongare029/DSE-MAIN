      ...
      <div className={`how__to__page__container ${classes.root}`}>
        <div className="page__body">
          ...
          <section className="dse__specialities">
            ...
            <Grid container spacing={0} className="dse__features">
                  ...
                  <div className="feature__card">
                    ...
                    <div className="info__section">
                      <p className="text-justify">
                        Upload diamonds, with a price of immediate, COD
                        delivery. Some diamonds we buy at your price, and for
                        others, we make a bid. We buy statistical samples of all
                        diamonds, and our system automatically adjusts our bids.
                        If you accept our bid, we instantly sent you a purchase
                        order. We always pay COD after GIA confirmation.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Grid item sm={6} xs={12} className="text-center right__section">
                <div className="card__container">
                  ...
                  <div className="feature__card">
                    ...
                    <div className="info__section">
                      <p className="text-justify">
                        You deliver the diamonds to your GIA Lab by the end of
                        the next business day. They inspect diamonds for us, to
                        confirm that they match the GIA Report. At prices under
                        $750/ct, we buy ungraded diamonds, based on your
                        assertion of your quality, and the IGI grades them for
                        us. We pay more for graded diamonds, and ones already in
                        the USA.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="feature__card">
                    ...
                    <div className="info__section">
                      <p className="text-justify mb-1">
                        ...
                        bank wire. For uncertified diamonds, we pay after
                        grading. Your diamonds must match the quality you
                        asserted.
                      </p>
              ...
              <Grid item sm={6} xs={12} className="text-center right__section">
                <div className="card__container last__card__container">
                  <div className="top__background"></div>
                  <div className="feature__card">
                    <div className="image__section">
                    ...
                    <div className="info__section">
                      <p className="text-justify">
                        ...
                        smaller number of specific diamonds. we are more likely
                        to accept your asking price. Our market making system
                        automatically raises our bids to fulfill our statistical
                        sampling requirements. If you hold out, we will likely
                        pay more, but then again, another vendor might offer
                        similar stones and we won't need yours.
                      </p>
                    </div>
                  </div>
                </div>
